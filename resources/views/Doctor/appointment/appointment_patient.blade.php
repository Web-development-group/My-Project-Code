                                ...
                                <table class="table table-hover js-basic-example contact_list">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="center">Account_status</th>
                                    ...
                                    <tbody>
                                        @foreach ($result as $data)
                                            <tr>
                                                ...
                                                <td class="center">{{ $data->verify }}</td>
                                                <td class="center">{{ $data->account_status }}</td>
                                                <td class="center">{{ $data->warning }}</td>
                                                <td class="center">{{ date('d-M-Y', strtotime($data->created)) }}</td>
                                                <td class="center">{{ date('d-M-Y', strtotime($data->updated)) }}</td>
                                                <td class="center">
                                                    <a href="{{ route('trash.appointment',['id' => $data->id])}}" onclick="deleteMsg('Are You Sure To Delete Appointment Patient?')">
