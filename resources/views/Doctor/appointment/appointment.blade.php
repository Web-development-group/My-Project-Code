                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" id="patient-form" action="{{ route('doctor.store.appointment') }}"
                                        ...
                                        @foreach ($result as $data)
                                            <tr>
                                                ...
                                                <td class="center">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-left">
                                                                    <form method="POST"
                                                                        ...
                                                                        action="{{ route('update.doctor.appointment', ['id' => $data->id]) }}"
                                                                        enctype="multipart/form-data"
                                                    ...
                                                    <a href="{{ route('destroy.doctor.appointment',['id' => $data->id])}}" onclick="deleteMsg('Are You Sure To Delete Doctor?')">
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('appointment.patient', ['id' => $data->id]) }}">
                                                        <button class="btn tblActnBtn">
