    ...
    <section class="content">
        <div class="container-fluid">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <ul class="breadcrumb breadcrumb-style ">
                            ...
                            <li class="breadcrumb-item bcrumb-2">
                                <a href="#" onClick="return false;">Doctor List</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div>
                        <button class="btn-hover color-2" class="center" type="button" data-toggle="modal" data-target="#doctors-form">
                            Add New &nbsp;<span class="fa fa-plus"></span>
                        </button>
                        <div class="modal fade" id="doctors-form" tabindex="-1" role="dialog" aria-labelledby="formModal"
                            aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="formModal">Add New Doctor</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form method="POST" id="doctor-form" action="{{ route('store.doctor')}}"
                                                ...
                                                <td class="center">
                                                    ...
                                                    <div class="modal fade" id="edit-form{{$data->id}}" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="formModal">Edit Doctor
                                                                    </h5>
                                                                ...
                                                                <div class="modal-body text-left">
                                                                    <form method="POST" id="doctor-form{{$data->id}}"
                                                                        action="{{ route('update.doctor',['id'=>$data->id]) }}"
                                                                        enctype="multipart/form-data"
                                                                        onsubmit="return validateDoctor({{$data->id}})"
                                                                        >
                                                                        @method('PUT')
                                                                        @csrf
                                                                        <label for="firstname">First Name</label>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="form-line">
                                                                                <input type="text" id="degree{{$data->id}}"
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="submit" form="doctor-form{{$data->id}}"
                                                                        class="btn btn-info waves-effect">Save</button>
                                                                    <button type="button"
                                                    ...
                                                    <a href="{{ route('trash.doctor',['id' => $data->id])}}" onclick="deleteMsg('Are You Sure To Delete Doctor?')">
