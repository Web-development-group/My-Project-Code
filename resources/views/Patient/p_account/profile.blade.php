                        ...
                        <div class="m-b-20">
                            <div class="contact-grid">
                                <div class="profile-header bg-dark">
                                    <div class="user-name">{{ $patient->firstname}}</div>
                                    <div class="name-center">{{ $patient->lastname}}</div>
                                </div>
                                <img src="{{ asset($patient->photo)}}" width="100" height="100" class="user-img" alt="">
                                <p style="color: rgb(44, 8, 248);">
                                    {{ $patient->address }}
                                </p>
                                <div>
                                    <span class="phone">
                                        <i class="material-icons" style="color: blue;">phone</i>{{ $patient->phone}}</span>
                                </div>
                                {{-- <div class="row">
                                    <div class="col-4">
                                        <h5>564</h5>
                    ...
                    <div class="tab-content">
                                        ...
                                        <div class="body">
                                            <div class="row">
                                                <div class="col-md-3 col-6 b-r">
                                                    <h5>First Name</h5>
                                                    <br>
                                                    <p class="text-muted">{{ $patient->firstname }}</p>
                                                </div>
                                                <div class="col-md-3 col-6 b-r">
                                                    <h5>Last Name</h5>
                                                    <br>
                                                    <p class="text-muted">{{ $patient->lastname }}</p>
                                                </div>
                                                <div class="col-md-3 col-6 b-r">
                                                    <h5>User Name</h5>
                                                    <br>
                                                ...
                                                <div class="col-md-3 col-6">
                                                    <h5>Email</h5>
                                                    <br>
                                                    <p style="color: blue">{{ $patient->email }}</p>
                                                </div>
                                            </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="usersettings" aria-expanded="false">
                            <div class="card">
                                ...
                                <div class="body">
                                    <form action="{{ route('update.patient.account',['id' => $patient->id])}}" method="POST" enctype="multipart/form-data" >
                                        @csrf
                                        @method('PUT')
