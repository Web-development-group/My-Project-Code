            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand">
                    <span class="logo-name">
                        <img src="{{ asset('website/images/logo.png')}}" height="30" width="120" alt="This is Site Logo">
                    </span>
                </a>
            </div>
                        ...
                        <ul class="dropdown-menu pullDown">
                            <li class="body">
                                <ul class="user_dw_menu">
                                    <li>
                                        <a href="{{ route('show.profile')}}" onClick="return true;">
                ...
                <ul class="list">
                    <li class="sidebar-user-panel active">
                        ...
                        <div class="profile-usertitle">
                            ...
                            <div class="profile-usertitle-job "> {{session('user')->email}} </div>
                        </div>
                    </li>
